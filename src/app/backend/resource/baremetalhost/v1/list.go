...
func GetBaremetalList(client apiextensionsclientset.Interface, dsQuery *dataselect.DataSelectQuery) (*types.CustomResourceDefinitionList, error) {
	...
	return toBaremetalList(BaremetalList.Items, nonCriticalErrors, dsQuery), nil
}

func toBaremetalList(crds []apiextensionsv1.CustomResourceDefinition, nonCriticalErrors []error, dsQuery *dataselect.DataSelectQuery) *types.CustomResourceDefinitionList {
